...
WebUI.setText(findTestObject('Import data/Page_TRMTracker/Input_RuleName'), 'Price Curve Definition')
...
WebUI.waitForElementVisible(findTestObject('Import data/Page_TRMTracker/Price Curve Definition/div_price curve'), 30)

//WebUI.mouseOver(findTestObject('Import data/Page_TRMTracker/Trader Definition/div_Trader'))
WebUI.click(findTestObject('Import data/Page_TRMTracker/Price Curve Definition/div_price curve'))
...
WebUI.waitForElementPresent(findTestObject('Import data/Page_TRMTracker/Price Curve Definition/div_upload_price curve'), 
    30)

//For Uploading file
CustomKeywords.'upload.uploadclass.uploadFile'(findTestObject('Import data/Page_TRMTracker/Price Curve Definition/div_upload_price curve'), 
    'C:\\Users\\ronish.shrestha\\Downloads\\Price Curve Definition')

WebUI.delay(2)

WebUI.click(findTestObject('Import data/Page_TRMTracker/Price Curve Definition/div_ok'))
...
for (i = 1; i < count; i++) {
    try {
        ...
        WebUI.verifyElementPresent(findTestObject('Import data/Page_TRMTracker/Price Curve Definition/div_pricecurve_message'), 
            30)
