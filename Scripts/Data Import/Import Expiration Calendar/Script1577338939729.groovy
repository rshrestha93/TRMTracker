...
WebUI.setText(findTestObject('Import data/Page_TRMTracker/Input_RuleName'), 'Expiration Calendar Definition')
...
WebUI.waitForElementVisible(findTestObject('Import data/Page_TRMTracker/Expiration calendar/div_Expiration'), 30)

//WebUI.mouseOver(findTestObject('Import data/Page_TRMTracker/Trader Definition/div_Trader'))
WebUI.click(findTestObject('Import data/Page_TRMTracker/Expiration calendar/div_Expiration'))
...
WebUI.waitForElementPresent(findTestObject('Import data/Page_TRMTracker/Expiration calendar/div_upload_Expiration'), 30)

//For Uploading file
CustomKeywords.'upload.uploadclass.uploadFile'(findTestObject('Import data/Page_TRMTracker/Expiration calendar/div_upload_Expiration'), 
    'C:\\Users\\ronish.shrestha\\Downloads\\Expiration Calendar Definition')

WebUI.delay(2)

WebUI.click(findTestObject('Import data/Page_TRMTracker/Expiration calendar/div_ok'))
