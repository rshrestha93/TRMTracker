...
//WebUI.waitForElementVisible(findTestObject('Import data/Page_TRMTracker/div_message'), 30)

//WebUI.verifyElementPresent(findTestObject('Import data/Page_TRMTracker/div_message'), 30)

//WebUI.refresh()
//def i=1
//def expected = 'Import process completed for as of date:12/11/2019'
def count=5
for(i=1;i<count;i++){
	...
	//if (i<count){
		...
		//try{
			...
			WebUI.waitForElementVisible(findTestObject('Import data/Page_TRMTracker/div_message'), 30)
			WebUI.verifyElementPresent(findTestObject('Import data/Page_TRMTracker/div_message'), 3)
...
//		if (WebUI.verifyElementPresent(findTestObject('Import data/Page_TRMTracker/div_message'), 3)){
//			break}
//		else{
