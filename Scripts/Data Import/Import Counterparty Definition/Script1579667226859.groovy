...
WebUI.setText(findTestObject('Import data/Page_TRMTracker/Input_RuleName'), 'Counterparty Definition')
...
WebUI.waitForElementVisible(findTestObject('Import data/Page_TRMTracker/Counterparty/div_counterparty'), 30)

//WebUI.mouseOver(findTestObject('Import data/Page_TRMTracker/Trader Definition/div_Trader'))
WebUI.click(findTestObject('Import data/Page_TRMTracker/Counterparty/div_counterparty'))
...
WebUI.waitForElementPresent(findTestObject('Import data/Page_TRMTracker/Counterparty/div_upload_counterparty'), 30)

//For Uploading file
CustomKeywords.'upload.uploadclass.uploadFile'(findTestObject('Import data/Page_TRMTracker/Counterparty/div_upload_counterparty'), 
    'C:\\Users\\ronish.shrestha\\Downloads\\Trader Definition')

WebUI.delay(2)

WebUI.click(findTestObject('Import data/Page_TRMTracker/Counterparty/div_ok'))
