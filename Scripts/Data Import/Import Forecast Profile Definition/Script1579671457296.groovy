...
WebUI.setText(findTestObject('Import data/Page_TRMTracker/Input_RuleName'), 'Forecast Profile Definition')
...
WebUI.waitForElementPresent(findTestObject('Import data/Page_TRMTracker/Forecast Profile Definition/div_upload_forecast'), 
    30)

//For Uploading file
CustomKeywords.'upload.uploadclass.uploadFile'(findTestObject('Import data/Page_TRMTracker/Forecast Profile Definition/div_upload_forecast'), 
    'C:\\Users\\ronish.shrestha\\Downloads\\contract definition import')

WebUI.delay(2)

WebUI.click(findTestObject('Import data/Page_TRMTracker/Contract Definition/div_ok'))
