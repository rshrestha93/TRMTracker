...
WebUI.setText(findTestObject('Import data/Page_TRMTracker/Input_RuleName'), 'Counterparty Contact Definition')
...
WebUI.waitForElementVisible(findTestObject('Import data/Page_TRMTracker/Counterparty Contact Definition/div_contact'), 30)

//WebUI.mouseOver(findTestObject('Import data/Page_TRMTracker/Trader Definition/div_Trader'))
WebUI.click(findTestObject('Import data/Page_TRMTracker/Counterparty Contact Definition/div_contact'))
...
WebUI.waitForElementPresent(findTestObject('Import data/Page_TRMTracker/Counterparty Contact Definition/div_upload_contact'), 
    30)

//For Uploading file
CustomKeywords.'upload.uploadclass.uploadFile'(findTestObject('Import data/Page_TRMTracker/Counterparty Contact Definition/div_upload_contact'), 
    'C:\\Users\\ronish.shrestha\\Downloads\\Trader Definition')

WebUI.delay(2)

WebUI.click(findTestObject('Import data/Page_TRMTracker/Counterparty Contact Definition/div_ok'))
