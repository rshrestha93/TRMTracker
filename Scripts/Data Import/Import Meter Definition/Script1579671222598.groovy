...
WebUI.setText(findTestObject('Import data/Page_TRMTracker/Input_RuleName'), 'Meter Definition')
...
WebUI.waitForElementVisible(findTestObject('Import data/Page_TRMTracker/Meter/div_Meter'), 30)

//WebUI.mouseOver(findTestObject('Import data/Page_TRMTracker/Trader Definition/div_Trader'))
WebUI.click(findTestObject('Import data/Page_TRMTracker/Meter/div_Meter'))
...
WebUI.waitForElementPresent(findTestObject('Import data/Page_TRMTracker/Meter/div_upload_meter'), 30)

//For Uploading file
CustomKeywords.'upload.uploadclass.uploadFile'(findTestObject('Import data/Page_TRMTracker/Meter/div_upload_meter'), 'C:\\Users\\ronish.shrestha\\Downloads\\Meter Definition')

WebUI.delay(2)

WebUI.click(findTestObject('Import data/Page_TRMTracker/Meter/div_ok'))
...
for (i = 1; i < count; i++) {
    try {
       ...
       // WebUI.waitForElementVisible(findTestObject('Import data/Page_TRMTracker/deal/div_deal_message'), 1)
