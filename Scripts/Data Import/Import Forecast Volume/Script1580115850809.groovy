...
WebUI.setText(findTestObject('Import data/Page_TRMTracker/Input_RuleName'), 'Forecast Volume')
...
WebUI.waitForElementVisible(findTestObject('Import data/Page_TRMTracker/Forecast Profile Definition/div_forecast'), 30)

//WebUI.mouseOver(findTestObject('Import data/Page_TRMTracker/Trader Definition/div_Trader'))
WebUI.click(findTestObject('Import data/Page_TRMTracker/Forecast Profile Definition/div_forecast'))
...
WebUI.waitForElementPresent(findTestObject('Import data/Page_TRMTracker/Forecast Volume/div_upload_forecast'), 30)

//For Uploading file
CustomKeywords.'upload.uploadclass.uploadFile'(findTestObject('Import data/Page_TRMTracker/Forecast Volume/div_upload_forecast'), 
    'C:\\Users\\ronish.shrestha\\Downloads\\Forecast Volume')

WebUI.delay(2)

WebUI.click(findTestObject('Import data/Page_TRMTracker/Forecast Volume/div_ok'))
...
for (i = 1; i < count; i++) {
    try {
        ...
        WebUI.waitForElementVisible(findTestObject('Import data/Page_TRMTracker/Forecast Volume/div_forecast_message'), 
            30)

        WebUI.verifyElementPresent(findTestObject('Import data/Page_TRMTracker/Forecast Volume/div_forecast_message'), 30)
