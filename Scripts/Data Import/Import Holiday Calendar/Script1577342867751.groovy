...
WebUI.setText(findTestObject('Import data/Page_TRMTracker/Input_RuleName'), 'Holiday Calendar Definition')
...
WebUI.waitForElementVisible(findTestObject('Import data/Page_TRMTracker/Holiday calendar/div_Holiday'), 30)

//WebUI.mouseOver(findTestObject('Import data/Page_TRMTracker/Trader Definition/div_Trader'))
WebUI.click(findTestObject('Import data/Page_TRMTracker/Holiday calendar/div_Holiday'))
...
WebUI.waitForElementPresent(findTestObject('Import data/Page_TRMTracker/Holiday calendar/div_upload_Holiday'), 30)

//For Uploading file
CustomKeywords.'upload.uploadclass.uploadFile'(findTestObject('Import data/Page_TRMTracker/Holiday calendar/div_upload_Holiday'), 
    'C:\\Users\\ronish.shrestha\\Downloads\\Holiday Calendar Definition')

WebUI.delay(2)

WebUI.click(findTestObject('Import data/Page_TRMTracker/Holiday calendar/div_ok'))
