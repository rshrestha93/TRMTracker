...
WebUI.setText(findTestObject('Import data/Page_TRMTracker/Input_RuleName'), 'Counterparty Contract Definition')
...
WebUI.waitForElementVisible(findTestObject('Import data/Page_TRMTracker/Counterparty Contract Definition/div_contract'), 30)

//WebUI.mouseOver(findTestObject('Import data/Page_TRMTracker/Trader Definition/div_Trader'))
WebUI.click(findTestObject('Import data/Page_TRMTracker/Counterparty Contract Definition/div_contract'))
...
WebUI.waitForElementPresent(findTestObject('Import data/Page_TRMTracker/Counterparty Contract Definition/div_upload_contract'), 
    30)

//For Uploading file
CustomKeywords.'upload.uploadclass.uploadFile'(findTestObject('Import data/Page_TRMTracker/Counterparty Contract Definition/div_upload_contract'), 
    'C:\\Users\\ronish.shrestha\\Downloads\\Trader Definition')

WebUI.delay(2)

WebUI.click(findTestObject('Import data/Page_TRMTracker/Counterparty Contract Definition/div_ok'))
