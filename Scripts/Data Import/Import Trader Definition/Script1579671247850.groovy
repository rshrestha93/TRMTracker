...
WebUI.setText(findTestObject('Import data/Page_TRMTracker/Input_RuleName'), 'Trader Definition')
...
WebUI.waitForElementVisible(findTestObject('Import data/Page_TRMTracker/Trader Definition/div_Trader'), 30)

//WebUI.mouseOver(findTestObject('Import data/Page_TRMTracker/Trader Definition/div_Trader'))
WebUI.click(findTestObject('Import data/Page_TRMTracker/Trader Definition/div_Trader'))
...
WebUI.waitForElementPresent(findTestObject('Import data/Page_TRMTracker/Trader Definition/div_upload_trader'), 30)

//For Uploading file
CustomKeywords.'upload.uploadclass.uploadFile'(findTestObject('Import data/Page_TRMTracker/Trader Definition/div_upload_trader'), 
    'C:\\Users\\ronish.shrestha\\Downloads\\Trader Definition')

WebUI.delay(2)

WebUI.click(findTestObject('Import data/Page_TRMTracker/Trader Definition/div_ok'))
...
for (i = 1; i < count; i++) {
    try {
        ...
        //WebUI.waitForElementVisible(findTestObject('Import data/Page_TRMTracker/Trader Definition/div_trader_message'), 30)

        WebUI.verifyElementPresent(findTestObject('Import data/Page_TRMTracker/Trader Definition/div_trader_message'), 30)
