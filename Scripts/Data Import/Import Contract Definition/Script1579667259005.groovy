...
WebUI.setText(findTestObject('Import data/Page_TRMTracker/Input_RuleName'), 'Contract Definition')
...
WebUI.waitForElementVisible(findTestObject('Import data/Page_TRMTracker/Contract Definition/div_contract'), 30)

//WebUI.mouseOver(findTestObject('Import data/Page_TRMTracker/Trader Definition/div_Trader'))
WebUI.click(findTestObject('Import data/Page_TRMTracker/Contract Definition/div_contract'))
...
WebUI.waitForElementPresent(findTestObject('Import data/Page_TRMTracker/Contract Definition/div_upload_contract'), 30)

//For Uploading file
CustomKeywords.'upload.uploadclass.uploadFile'(findTestObject('Import data/Page_TRMTracker/Contract Definition/div_upload_contract'), 
