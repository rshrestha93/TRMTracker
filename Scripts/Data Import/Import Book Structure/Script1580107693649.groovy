...
WebUI.setText(findTestObject('Import data/Page_TRMTracker/Input_RuleName'), 'Book Structure')
...
WebUI.waitForElementVisible(findTestObject('Import data/Page_TRMTracker/Book Structure/div_BookStructure'), 30)

//WebUI.mouseOver(findTestObject('Import data/Page_TRMTracker/Trader Definition/div_Trader'))
WebUI.click(findTestObject('Import data/Page_TRMTracker/Book Structure/div_BookStructure'))
...
WebUI.waitForElementPresent(findTestObject('Import data/Page_TRMTracker/Book Structure/div_upload_BookStructure'), 30)

//For Uploading file
CustomKeywords.'upload.uploadclass.uploadFile'(findTestObject('Import data/Page_TRMTracker/Book Structure/div_upload_BookStructure'), 
    'C:\\Users\\ronish.shrestha\\Downloads\\Book Structure import')

WebUI.waitForElementClickable(findTestObject('Import data/Page_TRMTracker/Book Structure/div_ok'), 0)

WebUI.click(findTestObject('Import data/Page_TRMTracker/Book Structure/div_ok'))
