...
WebUI.setText(findTestObject('Import data/Page_TRMTracker/Input_RuleName'), 'Delivery Path')
...
WebUI.waitForElementVisible(findTestObject('Import data/Page_TRMTracker/Delivery Path/div_delivery'), 30)

//WebUI.mouseOver(findTestObject('Import data/Page_TRMTracker/Trader Definition/div_Trader'))
WebUI.click(findTestObject('Import data/Page_TRMTracker/Delivery Path/div_delivery'))
...
WebUI.waitForElementPresent(findTestObject('Import data/Page_TRMTracker/Delivery Path/div_upload_delivery'), 30)

//For Uploading file
CustomKeywords.'upload.uploadclass.uploadFile'(findTestObject('Import data/Page_TRMTracker/Delivery Path/div_upload_delivery'), 
    'C:\\Users\\ronish.shrestha\\Downloads\\Delivery Path')

WebUI.delay(2)

WebUI.click(findTestObject('Import data/Page_TRMTracker/Delivery Path/div_ok'))
