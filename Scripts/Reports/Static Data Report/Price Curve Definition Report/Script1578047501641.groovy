...
//To Click Static Data Option
wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//span[contains(text(),'Static Data')]")))
WebElement StaticData = driver.findElement(By.xpath("//span[contains(text(),'Static Data')]"))
js.executeScript("arguments[0].scrollIntoView();", StaticData)
actions.doubleClick(StaticData).perform()

WebElement DailyReport = driver.findElement(By.xpath("//span[contains(text(),'Price Curve Definition Report')]"))
...
//Curve Name
wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[@class=\'dhxform_item_label_top browse_label\']//label[contains(text(),\'Curve Name\')]//ancestor::div[1]//following-sibling::div/input")))
WebElement CurveName = driver.findElement(By.xpath('//div[@class=\'dhxform_item_label_top browse_label\']//label[contains(text(),\'Curve Name\')]//ancestor::div[1]//following-sibling::div/input'))
actions.doubleClick(CurveName).perform()
...
WebElement CurveNameA = driver.findElement(By.xpath('//td[contains(text(),\'10 min\')]'))
WebElement CurveNameB = driver.findElement(By.xpath('//td[contains(text(),\'1234\')]'))
actions.keyDown(Keys.LEFT_CONTROL).click(CurveNameA).click(CurveNameB).keyUp(Keys.LEFT_CONTROL).perform()
...
//Curve Type
WebElement CurveType = driver.findElement(By.xpath("//label[contains(text(),'Curve Type')]/ancestor::div[1]/following-sibling::div/span/div/input[@class='dhxcombo_input']"))
CurveType.sendKeys('Commodity Type')
actions.click(CurveType).perform()
