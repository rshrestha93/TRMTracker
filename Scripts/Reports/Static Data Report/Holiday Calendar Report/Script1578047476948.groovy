...
WebElement DailyReport = driver.findElement(By.xpath("//span[contains(text(),'Holiday Calendar Report')]"))
...
wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//label[contains(text(),'Calendar Name')]/ancestor::div[1]/following-sibling::div/span/div/input[@class='dhxcombo_input']")))
WebElement CalendarName = driver.findElement(By.xpath("//label[contains(text(),'Calendar Name')]/ancestor::div[1]/following-sibling::div/span/div/input[@class='dhxcombo_input']"))
CalendarName.sendKeys('dashain')
actions.click(CalendarName).perform()
