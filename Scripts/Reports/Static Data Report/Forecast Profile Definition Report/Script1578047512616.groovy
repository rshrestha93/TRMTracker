...
WebElement DailyReport = driver.findElement(By.xpath("//span[contains(text(),'Forecast Profile Definition Report')]"))
...
//For Profile Name
wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//label[contains(text(),'Profile Name')]/ancestor::div[1]/following-sibling::div/span/div/input[@class='dhxcombo_input']")))
WebElement ProfileName = driver.findElement(By.xpath("//label[contains(text(),'Profile Name')]/ancestor::div[1]/following-sibling::div/span/div/input[@class='dhxcombo_input']"))
ProfileName.sendKeys('8')
actions.click(ProfileName).perform()

//For Profile Type
WebElement ProfileType = driver.findElement(By.xpath("//label[contains(text(),'Profile Type')]/ancestor::div[1]/following-sibling::div/span/div/input[@class='dhxcombo_input']"))
ProfileType.sendKeys('Forecast')
actions.click(ProfileType).perform()
