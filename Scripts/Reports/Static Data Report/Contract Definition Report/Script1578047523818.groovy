...
WebElement DailyReport = driver.findElement(By.xpath("//span[contains(text(),'Contract Definition Report')]"))
...
//For Contract Field
WebElement Contract = driver.findElement(By.xpath("//label[contains(text(),'Contract')]/ancestor::div[1]/following-sibling::div/span/div/input[@class='dhxcombo_input']"))
Contract.sendKeys('1')
actions.click(Contract).perform()
