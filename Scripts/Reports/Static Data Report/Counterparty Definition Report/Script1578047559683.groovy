...
WebElement DailyReport = driver.findElement(By.xpath("//span[contains(text(),'Counterparty Definition Report')]"))
...
//Counterparty Status
WebElement CounterpartyStatus = driver.findElement(By.xpath("//label[contains(text(),'Counterparty Status')]/ancestor::div[1]/following-sibling::div/span/div/input[@class='dhxcombo_input']"))
CounterpartyStatus.sendKeys('1')
actions.click(CounterpartyStatus).perform()
