...
WebElement Report = driver.findElement(By.xpath("//span[contains(text(),'Deal Price Detail Report')]"))
...
wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath('//table[@class=\'a517\']')))
WebElement verify = driver.findElement(By.xpath('//table[@class=\'a517\']'))
