...
WebElement Report = driver.findElement(By.xpath("//span[contains(text(),'EoD Trade Report')]"))
...
wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath('//table[@class=\'a287\']')))
WebElement verify = driver.findElement(By.xpath('//table[@class=\'a287\']'))
