...
wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//span[contains(text(),'Deal')]")))
WebElement Deal = driver.findElement(By.xpath("//span[contains(text(),'Deal')]"))
js.executeScript("arguments[0].scrollIntoView();", Deal)
actions.doubleClick(Deal).perform()

WebElement Report = driver.findElement(By.xpath("//span[contains(text(),'Deal Audit Trail Detail Report')]"))
...
//Update Date From
WebElement Updatedatefrom = driver.findElement(By.xpath("//label[contains(text(),'Updated Date From')]//ancestor::div[1]//following-sibling::div[1]/input"))
Updatedatefrom.sendKeys('12/31/2017')

//Update Date To
WebElement Updatedateto = driver.findElement(By.xpath("//label[contains(text(),'Updated Date To')]//ancestor::div[1]//following-sibling::div[1]/input"))
Updatedateto.sendKeys('12/31/2017')
...
wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath('//table[@class=\'a117\']')))
WebElement verify = driver.findElement(By.xpath('//table[@class=\'a117\']'))
