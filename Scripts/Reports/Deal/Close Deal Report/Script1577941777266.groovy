...
WebElement Report = driver.findElement(By.xpath("//span[contains(text(),'Close Deal Report')]"))
...
//For Term Start
WebElement TermStart = driver.findElement(By.xpath("//label[contains(text(),'Term Start')]//ancestor::div[1]//following-sibling::div[1]/input"))
TermStart.sendKeys('12/31/2017')
...
//For Deal Type
WebElement DealType = driver.findElement(By.xpath("//label[contains(text(),'Deal Type')]/ancestor::div[1]/following-sibling::div/span/div/input[@class='dhxcombo_input']"))
DealType.sendKeys('Cash')
actions.click(DealType).perform()
...
wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath('//table[@class=\'a91\']')))
WebElement verify = driver.findElement(By.xpath('//table[@class=\'a91\']'))
