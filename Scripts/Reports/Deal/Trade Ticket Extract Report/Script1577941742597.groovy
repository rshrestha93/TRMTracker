...
WebElement Report = driver.findElement(By.xpath("//span[contains(text(),'Trade Ticket Extract Report')]"))
...
//For Deal ID 
wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//label[contains(text(),'Deal ID')]//ancestor::div[1]//following-sibling::div[1]/input")))
...
wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath('//table[@class=\'a247\']')))
WebElement verify = driver.findElement(By.xpath('//table[@class=\'a247\']'))
