...
WebElement target = driver.findElement(By.xpath('//span[contains(text(),\'Credit Risk\')]'))

actions.doubleClick(target).perform()

WebElement target1 = driver.findElement(By.xpath('//span[contains(text(),\'Counterparty Detail Report\')]'))
...
WebElement AccountStatus = driver.findElement(By.xpath('//label[contains(text(),\'Account Status\')]//ancestor::div[1]//following-sibling::div/span/div/input'))
//AccountStatus.click()
AccountStatus.sendKeys('Active')
AccountStatus.sendKeys(Keys.ENTER)
