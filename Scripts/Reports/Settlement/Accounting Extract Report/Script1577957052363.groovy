...
WebElement DailyReport = driver.findElement(By.xpath("//span[contains(text(),'Accounting Extract Report')]"))
...
wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//label[contains(text(),'Accounting Month')]//ancestor::div[1]//following-sibling::div[1]/input")))
...
WebElement AsOfDate = driver.findElement(By.xpath("//label[contains(text(),'Accounting Month')]//ancestor::div[1]//following-sibling::div[1]/input"))
