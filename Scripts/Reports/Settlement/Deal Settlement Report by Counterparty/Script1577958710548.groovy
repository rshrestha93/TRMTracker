...
WebElement DailyReport = driver.findElement(By.xpath("//span[contains(text(),'Deal Settlement Report by Counterparty')]"))
...
//Forth Frame 
WebElement frame4 = driver.findElement(By.xpath("//div[contains(@class,'dhx_cell_cont_wins')]//iframe"))
...
//Fifth Frame
WebElement frame5 = driver.findElement(By.xpath('//div[contains(@class,\'dhxlayout_base_dhx_web\')]//div[contains(@class,\'dhxlayout_base_dhx_web\')]//div[@class=\'dhx_cell_layout\']//iframe'))
