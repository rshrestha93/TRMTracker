...
//TO Click Settlement option
wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//span[contains(text(),'Settlement')]")))
WebElement Settlement = driver.findElement(By.xpath("//span[contains(text(),'Settlement')]"))
js.executeScript("arguments[0].scrollIntoView();", Settlement)
actions.doubleClick(Settlement).perform()

WebElement DailyReport = driver.findElement(By.xpath("//span[contains(text(),'Invoice Charge Type Level Extract Report')]"))
...
//For Counterparty
wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[@class=\'dhxform_item_label_top browse_label\']//label[contains(text(),\'Counterparty\')]//ancestor::div[1]//following-sibling::div/input")))
...
wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[@class=\'dhxform_item_label_top browse_label\']//label[contains(text(),\'Contract\')]//ancestor::div[1]//following-sibling::div/input")))
WebElement Contract = driver.findElement(By.xpath('//div[@class=\'dhxform_item_label_top browse_label\']//label[contains(text(),\'Contract\')]//ancestor::div[1]//following-sibling::div/input'))
actions.doubleClick(Contract).perform()
...
wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath('//td[contains(text(),\'00test\')]')))
WebElement ContractA = driver.findElement(By.xpath('//td[contains(text(),\'00test\')]'))
WebElement ContractB = driver.findElement(By.xpath('//td[contains(text(),\'0_tester\')]'))
actions.keyDown(Keys.LEFT_CONTROL).click(ContractA).click(ContractB).keyUp(Keys.LEFT_CONTROL).perform()

wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath('//div[@class=\'dhxtoolbar_text\']')))
WebElement Clicka = driver.findElement(By.xpath('//div[@class=\'dhxtoolbar_text\']')).click()

//For As Of Date
driver.switchTo().parentFrame()
WebElement AsOfDate = driver.findElement(By.xpath("//label[contains(text(),'Delivery Month')]//ancestor::div[1]//following-sibling::div[1]/input"))
