...
WebElement DailyReport = driver.findElement(By.xpath("//span[contains(text(),'Deal Settlement Report by Book')]"))
...
wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath('//table[@class=\'a130\']')))
WebElement verify = driver.findElement(By.xpath('//table[@class=\'a130\']'))
