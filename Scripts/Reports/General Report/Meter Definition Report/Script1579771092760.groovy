...
WebElement Report = driver.findElement(By.xpath("//span[contains(text(),'Meter Definition Report')]"))
...
//For Commodity
wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//label[contains(text(),'Commodity')]/ancestor::div[1]/following-sibling::div/span/div/input[@class='dhxcombo_input']")))
WebElement Commodity = driver.findElement(By.xpath("//label[contains(text(),'Commodity')]/ancestor::div[1]/following-sibling::div/span/div/input[@class='dhxcombo_input']"))
Commodity.sendKeys('aa')
actions.click(Commodity).perform()
...
//For Meter
WebElement Meter = driver.findElement(By.xpath('//div[@class=\'dhxform_item_label_top browse_label\']//label[contains(text(),\'Meter\')]//ancestor::div[1]//following-sibling::div/input'))
actions.doubleClick(Meter).perform()

WebElement Mframe4 = driver.findElement(By.xpath("//div[@class='dhxwin_active']//div[@class='dhx_cell_wins']//iframe"))
driver.switchTo().frame(Mframe4)

wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath('//td[contains(text(),\'123\')]')))
WebElement MeterA = driver.findElement(By.xpath('//td[contains(text(),\'123\')]'))
WebElement MeterB = driver.findElement(By.xpath('//td[contains(text(),\'1234\')]'))
actions.keyDown(Keys.LEFT_CONTROL).click(MeterA).click(MeterB).keyUp(Keys.LEFT_CONTROL).perform()
