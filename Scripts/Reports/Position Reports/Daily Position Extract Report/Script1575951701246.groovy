...
WebElement DailyReport = driver.findElement(By.xpath("//span[contains(text(),'Daily Position Extract Report')]"))
...
wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath('//table[@class=\'a457\']')))
WebElement verify = driver.findElement(By.xpath('//table[@class=\'a457\']'))
