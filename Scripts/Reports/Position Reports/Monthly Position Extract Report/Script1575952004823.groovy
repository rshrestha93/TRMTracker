...
WebElement MonthlyReport = driver.findElement(By.xpath('//span[contains(text(),\'Monthly Position Extract Report\')]'))
...
/*
'To locate table'
WebElement Table = driver.findElement(By.xpath("//table[@class=\'a427\']"))
...
for (def row = 3; row <= (rows_count-42); row++) {
