...
WebElement MonthlyReport = driver.findElement(By.xpath('//span[contains(text(),\'Power ToU Position Report\')]'))
...
//Vefyfing Table
wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath('//table[@class=\'a88\']')))
WebElement verify = driver.findElement(By.xpath('//table[@class=\'a88\']'))
