...
WebElement DailyReport = driver.findElement(By.xpath("//span[contains(text(),'Position Attribution Report')]"))
...
WebElement PriorAsOfDate = driver.findElement(By.xpath("//label[contains(text(),'Prior As of Date')]//ancestor::div[1]//following-sibling::div[1]/input"))
PriorAsOfDate.sendKeys('12/31/2017')

WebElement CurrentAsOfDate = driver.findElement(By.xpath("//label[contains(text(),'Current As of Date')]//ancestor::div[1]//following-sibling::div[1]/input"))
CurrentAsOfDate.sendKeys('12/31/2017')
...
//Veerifying Table
wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath('//table[@class=\'a275\']')))
WebElement verify = driver.findElement(By.xpath('//table[@class=\'a275\']'))
