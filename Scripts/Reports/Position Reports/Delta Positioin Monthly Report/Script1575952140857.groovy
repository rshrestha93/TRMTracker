...
WebElement MonthlyReport = driver.findElement(By.xpath('//span[contains(text(),\'Delta Position Monthly Report\')]'))

js.executeScript('arguments[0].scrollIntoView();', MonthlyReport)

actions.doubleClick(MonthlyReport).perform()
...
WebElement CommodityOption = driver.findElement(By.xpath("//div[contains(text(),'001')]"))
actions.click(CommodityOption).perform()
...
wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath('//table[@class=\'a69\']')))
WebElement verify = driver.findElement(By.xpath('//table[@class=\'a69\']'))
