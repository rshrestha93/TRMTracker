...
//wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//span[contains(text(),'Position')]")))
WebElement HourlyReport = driver.findElement(By.xpath('//span[contains(text(),\'Hedging Calendar Report\')]'))
...
wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath('//table[@class=\'a33\']')))
WebElement verify = driver.findElement(By.xpath('//table[@class=\'a33\']'))


/*
'To locate table'
WebElement Table = driver.findElement(By.xpath("//body/div[@id='report-body']/div[@id='cn-ssrs-viewer-report']/div[@id='oReportDiv']/div[@class='ap']/table/tbody/tr/td[@id='oReportCell']/div[@id='5xB_gr']/table[@class='a447']/tbody[1]"))
