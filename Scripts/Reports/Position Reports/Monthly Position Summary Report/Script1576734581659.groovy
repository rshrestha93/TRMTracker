...
WebElement MonthlyReport = driver.findElement(By.xpath('//span[contains(text(),\'Monthly Position Summary Report\')]'))
...
'To locate table'
WebElement Table = driver.findElement(By.xpath("//table[@class=\'a91\']"))
...
for (def row = 3; row <= rows_count; row++) {
	'Expected value from Table'
	String ExpectedValue = "6713"
	
	wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[@class='a429xB']//tr[3]//td[15]")))
	String ActualTrader= driver.findElement(By.xpath("//div[@class='a429xB']//tr["+ row +"]//td[15]")).getText()
