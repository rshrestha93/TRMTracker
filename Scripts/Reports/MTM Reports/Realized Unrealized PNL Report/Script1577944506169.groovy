...
WebElement DailyReport = driver.findElement(By.xpath("//span[contains(text(),'Realized Unrealized PNL Report')]"))
...
wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath('//table[@class=\'a97\']')))
WebElement verify = driver.findElement(By.xpath('//table[@class=\'a97\']'))
