...
WebElement DailyReport = driver.findElement(By.xpath("//span[contains(text(),'PNL CrossTab Summary Report')]"))
...
wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath('//table[@class=\'a45\']')))
WebElement verify = driver.findElement(By.xpath('//table[@class=\'a45\']'))
