...
WebElement DailyReport = driver.findElement(By.xpath("//span[contains(text(),'MTM Extract Report')]"))
...
WebElement DealID = driver.findElement(By.xpath("//label[contains(text(),'Deal')]//ancestor::div[1]//following-sibling::div[1]/input"))
