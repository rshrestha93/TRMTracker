...
WebElement DailyReport = driver.findElement(By.xpath("//span[contains(text(),'MTM Report by Charges')]"))
...
wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath('//table[@class=\'a83\']')))
WebElement verify = driver.findElement(By.xpath('//table[@class=\'a83\']'))
