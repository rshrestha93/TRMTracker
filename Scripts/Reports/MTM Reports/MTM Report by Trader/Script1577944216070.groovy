...
WebElement DailyReport = driver.findElement(By.xpath("//span[contains(text(),'MTM Report by Trader')]"))
...
wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath('//table[@class=\'a58\']')))
WebElement verify = driver.findElement(By.xpath('//table[@class=\'a58\']'))
