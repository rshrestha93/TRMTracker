...
WebElement DailyReport = driver.findElement(By.xpath("//span[contains(text(),'PNL Report by Book and Counterparty')]"))
...
wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath('//table[@class=\'a64\']')))
WebElement verify = driver.findElement(By.xpath('//table[@class=\'a64\']'))
