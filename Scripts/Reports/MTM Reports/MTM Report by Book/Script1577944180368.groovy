...
WebElement DailyReport = driver.findElement(By.xpath("//span[contains(text(),'MTM Report by Book')]"))
...
wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath('//table[@class=\'a39\']')))
WebElement verify = driver.findElement(By.xpath('//table[@class=\'a39\']'))
