...
WebElement Report = driver.findElement(By.xpath("//span[contains(text(),'At Risk Report')]"))
...
//At Risk Criteria
wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[@class=\'dhxform_item_label_top browse_label\']//label[contains(text(),\'At Risk Criteria\')]//ancestor::div[1]//following-sibling::div/input")))
WebElement AtRiskCriteria = driver.findElement(By.xpath('//div[@class=\'dhxform_item_label_top browse_label\']//label[contains(text(),\'At Risk Criteria\')]//ancestor::div[1]//following-sibling::div/input'))
actions.doubleClick(AtRiskCriteria).perform()
...
wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath('//td[contains(text(),\'19\')]')))
WebElement AtRiskCriteriaA = driver.findElement(By.xpath('//td[contains(text(),\'19\')]'))
WebElement AtRiskCriteriaB = driver.findElement(By.xpath('//td[contains(text(),\'21\')]'))
actions.keyDown(Keys.LEFT_CONTROL).click(AtRiskCriteriaA).click(AtRiskCriteriaB).keyUp(Keys.LEFT_CONTROL).perform()
...
//Measure
WebElement Measure = driver.findElement(By.xpath("//label[contains(text(),'Measure')]/ancestor::div[1]/following-sibling::div/span/div/input[@class='dhxcombo_input']"))
actions.click(Measure).perform()

WebElement Option = driver.findElement(By.xpath("//div[contains(text(),'VaR')]"))
