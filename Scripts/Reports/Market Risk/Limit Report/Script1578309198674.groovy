...
WebElement Report = driver.findElement(By.xpath("//span[contains(text(),'Limit Report')]"))
...
//Limit For
WebElement LimitFor = driver.findElement(By.xpath("//label[contains(text(),'Limit For')]/ancestor::div[1]/following-sibling::div/span/div/input[@class='dhxcombo_input']"))
actions.click(LimitFor).perform()

WebElement LimitForOption = driver.findElement(By.xpath("//div[contains(text(),'Commodity')]"))
actions.click(LimitForOption).perform()

//Limit Type
WebElement LimitType = driver.findElement(By.xpath("//label[contains(text(),'Limit Type')]/ancestor::div[1]/following-sibling::div/span/div/input[@class='dhxcombo_input']"))
actions.click(LimitType).perform()

WebElement LimitTypeOption = driver.findElement(By.xpath("//div[contains(text(),'At Risk Limit')]"))
actions.click(LimitTypeOption).perform()

//Limit Group
WebElement LimitGroup = driver.findElement(By.xpath("//label[contains(text(),'Limit Group')]/ancestor::div[1]/following-sibling::div/span/div/input[@class='dhxcombo_input']"))
actions.click(LimitGroup).perform()

WebElement LimitGroupOption = driver.findElement(By.xpath("//div[contains(text(),'roni')]"))
actions.click(LimitGroupOption).perform()
