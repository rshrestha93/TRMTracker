...
WebElement Report = driver.findElement(By.xpath("//span[contains(text(),'Implied Volatility Report')]"))
...
//Index
wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[@class=\'dhxform_item_label_top browse_label\']//label[contains(text(),\'Index\')]//ancestor::div[1]//following-sibling::div/input")))
WebElement Index = driver.findElement(By.xpath('//div[@class=\'dhxform_item_label_top browse_label\']//label[contains(text(),\'Index\')]//ancestor::div[1]//following-sibling::div/input'))
actions.doubleClick(Index).perform()

WebElement xpathframe1 = driver.findElement(By.xpath("//div[contains(@class,'dhx_cell_cont_wins')]//iframe"))
