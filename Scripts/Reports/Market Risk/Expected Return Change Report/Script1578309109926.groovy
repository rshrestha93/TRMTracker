...
WebElement Report = driver.findElement(By.xpath("//span[contains(text(),'Expected Return Change Report')]"))
...
WebElement xpathframe1 = driver.findElement(By.xpath("//div[@class='dhx_cell_cont_wins']//iframe"))
